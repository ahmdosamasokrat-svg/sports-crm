...
<section class="panel" style="margin-top:20px">
    ...
    <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 14px;">
        ...
        <a class="stat-card action-card" href="{{ route('v2.settings.stages.index') }}">
            <span><i class="bi bi-diagram-3" style="color:#dc2637"></i> {{ __('crm.pipelines_and_stages') ?? 'المسارات والمراحل' }}</span>
            <b style="font-size:17px;margin-top:8px">{{ __('إدارة مسارات العمل والمراحل والأسئلة') }}</b>
        </a>
